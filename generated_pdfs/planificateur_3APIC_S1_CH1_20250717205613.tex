...
\begin{document}
	...
	\begin{boxone}
		\begin{multicols}{2} 
			\textcolor{black}{\myfont Lycée :  } {\sffamily  LYCEE MOUSAID TINGHIR}
			\\
	...
	\begin{longtable}{|>{\centering\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{5cm}|>{\raggedright\arraybackslash}p{13.5cm}|>{\raggedright\arraybackslash}p{5cm}|}
		...
		\end{BoxRafa}
		\begin{BoxRafa}[colback=blue!10]{Another title}
			This box has a light‑blue background instead of yellow.
